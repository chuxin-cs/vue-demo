 ...
 * console.log(rgb); // "rgba(200, 250, 214, 0.24)"
 */
export function rgbAlpha(colorVal, alpha) {
 ...
 */
export const toCssVar = (propertyPath) => {
 ...
 * convert to CSS vars
 */
export const getTailwinConfg = (propertyPath) => {
 ...
 */
export const getRgbFromColorChannel = (propertyPath) => {
	const variants = getThemeTokenVariants(propertyPath);
	const result = variants.reduce(
		(acc, variant) => {
 ...
 */
export const getThemeTokenVariants = (propertyPath) => {
	const keys = propertyPath.split(".");
	const val = keys.reduce((obj, key) => {
 ...
 */
export const addColorChannels = (obj) => {
	const result = {};
